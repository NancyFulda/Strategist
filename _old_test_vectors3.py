...
if METHOD in ['BSE_encoder','BSE_encoder_SIF','BSE_encoder_MEAN']:
    ...
    #model = 'output_w2v_wikipedia_z_mu/195_encoder.pkl'
    ...
    #model = 'output_autoencoder_plus_neg_wikipedia_z_mu/12_encoder.pkl'
    ...
    # ** Seventh Round **
    #model = 'output_autoencoder_book_corpus/17_encoder.pkl'
    #model = 'output_context_plus_inv_text_book_corpus/16_encoder.pkl'
    #model = 'output_context_plus_inv_text_book_corpus_trial2/19_encoder.pkl'
    #model = 'output_context_plus_w2v_book_corpus/12_encoder.pkl'
    ...
    # ** Eighth Round **
    model = 'output_context_book_corpus/33_encoder.pkl'
    ...
    #model = 'output_context_plus_w2v_split_corpus_2/16_encoder.pkl'
...
def test_ant_syn_trios(n, filename='evaluation_sets/ant_syn_trios.txt'):
    f=open(filename,'r')
    data = f.read()
    lines = data.split('\n')
...
def test_neg_syn_trios(n, filename='evaluation_sets/neg_syn_trios.txt'):
    f=open(filename,'r')
    data = f.read()
    lines = data.split('\n')
...
print('\n')
print('/curated text')
test_ant_syn_trios(100, 'evaluation_sets/ant_syn_trios_curated.txt')
test_neg_syn_trios(100, 'evaluation_sets/neg_syn_trios_curated.txt')
